    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_documento', models.CharField(choices=[('CC', 'Cedula de ciudadanía'), ('TI', 'Tarjeta de identidad'), ('PEP', 'PEP')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('presente', models.CharField(choices=[('Asiste', 'Asiste'), ('Falla', 'Falla'), ('Retardo', 'Retardo'), ('Novedad', 'Novedad')], default=False, max_length=45)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia', models.CharField(choices=[('LUNES', 'Lunes'), ('MARTES', 'Martes'), ('MIERCOLES', 'Miercoles'), ('JUEVES', 'Jueves'), ('VIERNES', 'Viernes'), ('SABADO', 'Sabado'), ('DOMINGO', 'Domingo')], max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fichas', models.ManyToManyField(to='asistencia.ficha')),
                ('registro_asistencia', models.ManyToManyField(blank=True, to='asistencia.asistencia')),
            ],
            options={
